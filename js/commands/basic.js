...
window.OmegaCommands.Basic = {
    ...
    help: function(terminal) {
        ...
        terminal.log('');
        terminal.log('🎨 NFT GENERATOR:', 'info');
        terminal.log('  trait                Open visual NFT generator UI ⭐');
        terminal.log('  traits               Alternative command for generator');
        terminal.log('  nftgen               Short for NFT generator');
        terminal.log('');
        terminal.log('🏛️ ROME NETWORK:', 'info');
        terminal.log('  rome                 Rome Protocol integration', 'output');
        terminal.log('  rome token create    Create ERC20 token on Rome', 'output');
        terminal.log('  rome ens register    Register .rome domain names', 'output');
        terminal.log('  rome wallet create   Create Rome Network wallet', 'output');
        terminal.log('');
        terminal.log('⚡ MEGAETH NETWORK:', 'info');
        terminal.log('  megaeth              MegaETH ultra-fast integration', 'output');
        terminal.log('  megaeth token create Create ERC20 token on MegaETH', 'output');
        terminal.log('  megaeth ens register Register .megaeth domain names', 'output');
        terminal.log('  megaeth wallet create Create MegaETH Network wallet', 'output');
        terminal.log('');
